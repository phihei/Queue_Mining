...
\else
 ...
 \pdfcompresslevel=9
 \pdfinfo{
    /CreationDate (D:20210425110000) % date format is year(4) month(2) day(2) hour(2) minute(2) second(2)
    /ModDate      (D:\pdfdate)
 }
 \hypersetup{
...
\renewcommand{\listfigurename}{Appendix} % new name for the list of figures
...
%\linespread{1.5}\selectfont                    % switch to 1.5 linespacing

\mainmatter
\begingroup
\let\clearpage\relax
\include{abstract}
\include{chapter1}                              % include file chapter1.tex (this is what you have to provide!)
\include{chapter2}
\include{chapter3}
\include{chapter4}
\include{chapter5}
